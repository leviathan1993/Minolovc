...
##        Button(frame, text="-").grid(row=1, column=2)
    ...
    def callback(self):
        ...
        self.minesweeper.mines1234 = min(int(self.e3.get3),self.minesweeper.st_stolpcev1234*self.minesweeper.st_vrstic1234) #Število min ne sme biti večje od velikosti igralnega polja
