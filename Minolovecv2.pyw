...
class Minesweeper():
    def __init__(self, master, vrstice,stolpci,mine):
        ...
        filemenu.add_command(label="Izhod", command=root.destroy)
        ...
        levelmenu.add_command(label="Težka", command=self.težka)
        levelmenu.add_command(label="Zelo težka", command=self.zelo_težka)
    ...
    def zelo_težka(self):
        ...
        self.st_stolpcev1234 = 30
        self.mines1234=668
        self.vidni = True #Skrij številke
        self.nova_igra()
...
##        Button(frame, text="-").grid(row=1, column=2)
    ...
    def callback(self):
        ...
        self.minesweeper.st_vrstic1234 = int(self.e1.get1)
        self.minesweeper.st_stolpcev1234 = int(self.e2.get2)
        ...
        self.minesweeper.vidni = self.var.get()
